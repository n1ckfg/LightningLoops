...
var ddController;
var ddControllerModelPath = "../models/ddcontroller.obj";
...
function init() {
    ...
    //scene.add(light);
    var ddController_mtl = new THREE.MeshBasicMaterial();

    var loader = new THREE.OBJLoader();
    ddController = loader.load(ddControllerModelPath, function(object) {
        ddController = object;
        ddController.name = "dd";
        ddController.material = ddController_mtl;
        scene.add(ddController);
    });
